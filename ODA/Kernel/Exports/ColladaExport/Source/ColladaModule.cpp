...
{
  return TD_COLLADA_EXPORT::exportCollada(pDb, pFileName, pPallete, numColors, NULL, matTransform, pMapDeviations, useDoublePrecision);
}
...
OdResult ColladaModule::exportCollada(OdDbBaseDatabase *pDb, 
  ...
  bool useDoublePrecision)
{
  return TD_COLLADA_EXPORT::exportCollada(pDb, pFileName, pPallete, numColors, &pEntity, matTransform, pMapDeviations, useDoublePrecision);
}
}
