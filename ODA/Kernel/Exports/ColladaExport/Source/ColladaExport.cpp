...
namespace TD_COLLADA_EXPORT
{
  ...
  protected:
    ...
    OdSmartPtr<OdGsViewImpl> createViewObject()
    {
      ...
      ((OdColladaOut*)pP.get())->init(m_pEntityDataArr, m_pColladaMaterialData, m_pLightExp, m_matTransform, m_pMapDeviations);
      return pP;
    }
                                       ...
                                       const std::map<OdDbStub*, double>* pMapDeviations )
  {
    ...
    try
    {
      ...
      ((StubDeviceModuleText*)pGsModule.get())->init(pEntityDataArr, pColladaMaterialData, pLightExp, matTransform, pMapDeviations );
    ...
    bool useDoublePrecision)
  {
    ...
    try
    {
      ...
      OdGeVector3dArray lightDirsArr;
      {
        ...
        ret = CollectData(pDb, &entityDataArr, &pColladaMaterialData, &exportLights, pPallete, numColors, pEntity, matTransform, pMapDeviations);
      }
      ...
      {      
        ...
        //export materials
        {
          ...
          exportImages.exportImages(pColladaMaterialData.m_matDataArr, pFileName);
