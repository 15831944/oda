  ...
  public:
    ...
    { OdUInt64 calcSize = 0;
      ...
      for (OdUInt32 nArray = 0; nArray < nArrays; nArray++)
        calcSize += arrayElement((OdTrVisArrayId)nArray).m_uSize + sizeof(OdTrVisArrayWrapper);
      return calcSize;
    }
    ...
    { OdTrVisFlatMetafileContainer *pCont = static_cast<OdTrVisFlatMetafileContainer*>(OdFlatMetafileContainer::clone(pGaps));
      ...
      { const OdTrVisArrayWrapper &fromArr = arrayElement((OdTrVisArrayId)nArray);
        OdTrVisArrayWrapper newArr; newArr.setArray((OdTrVisArrayWrapper::Type)fromArr.m_type, fromArr.m_pData, fromArr.m_uSize);
