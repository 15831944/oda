...
typedef OdSmartPtr<class OdGiRasterImageFileTexture> OdGiRasterImageFileTexturePtr;
class OdGiRasterImageFileTexture : public OdGiRasterImageTexture // public OdGiImageFileTexture
{
public:
...
private:
  ...
  //void setRasterImage(const OdGiRasterImage* pRasterImage)
  //{
  //  m_pRasterImage = reinterpret_cast<const OdRxObject*>(pRasterImage);
  //}
  //const OdGiRasterImage *rasterImage() const
  //{
...
inline void textureToMaterialMap(OdGiMaterialTexturePtr pTexture, OdGiMaterialMap& materialMap)
{
  ...
  OdGiRasterImageFileTexture* pFileTexture = (OdGiRasterImageFileTexture*) pTexture.get();
  materialMap.setSourceFileName(pFileTexture->sourceFileName());
}
