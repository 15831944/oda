...
#include "DevGuideCommandsModule.h"
...
#include "DevGuideCmdDef.h"

#undef CMD_DEF_CLASS
#undef CMD_DEF


ODRX_DEFINE_DYNAMIC_MODULE(DevGuideCommandsModule);


void DevGuideCommandsModule::initApp()
{
...
void DevGuideCommandsModule::uninitApp()
{
  OdEdCommandStackPtr pCommands = odedRegCmds();
